    ...
    class Program
    {
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                ...
                {
                    services.AddScheduler(hostContext.Configuration.GetSection("Scheduler"), (services, configuration) => )
                        .AddRunner()
                        .AddPlugins(hostContext.Configuration.GetSection("SchedulerPlugins"));
                });
    }
